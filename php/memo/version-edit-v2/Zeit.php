...
class Zeit {
  ...
  public static function datumYmdHis($dateTime = null, $default = "") {
    ...
    /**
     * Liefert das Datum in der Form YYYY-MM-DD-HH
     * @param \DateTime $dateTime Datum. Wenn null, dann liefere aktuelle Zeit.
     * @return string
     */
    public static function datumYmdH($dateTime = null) {
        return self::datumString($dateTime, "Y-m-d-H");
    }
